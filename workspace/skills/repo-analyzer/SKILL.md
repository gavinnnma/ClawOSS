---
name: repo-analyzer
description: "Analyze repo health and conventions BEFORE queuing any issue. MANDATORY health gate: stars >=200, last commit <2wk, merge time <14d, review rate >50%, open PRs <50. Use ~/clawOSS/scripts/repo-health-check.sh for automation."
user-invocable: true
---
...
```bash
~/clawOSS/scripts/repo-health-check.sh {owner}/{repo}
```
